...
# Here's the problem: you want to get the pb_compile deps off the
# language definition, but you cant actually resolve those files until
# within a rule. So you can't really use them in a macro, AFAICT.
