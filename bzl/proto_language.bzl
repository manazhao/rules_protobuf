def proto_language_impl(ctx):
    return struct(
        proto_language = struct(
            ...
            pb_compile_deps = ctx.attr.pb_compile_deps,
            pb_runtime_deps = ctx.attr.pb_runtime_deps,
            ...
            grpc_runtime_deps = ctx.attr.grpc_runtime_deps,
        ),
    )

proto_language = rule(
    implementation = proto_language_impl,
    outputs = {
    },
    attrs = {
